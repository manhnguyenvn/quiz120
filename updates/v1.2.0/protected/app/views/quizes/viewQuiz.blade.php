...
<script src="{{Helpers::assetWithCacheBuster('js/social-sharing.js')}}"></script>
<script src="{{Helpers::assetWithCacheBuster('js/jquery.circliful.js')}}"></script>
<script>
    (function() {
        var body = $('body');
        SocialSharing.parse();
...
@if(App::isLocal())
<script data-main="{{ Helpers::assetWithCacheBuster('js/quiz/init.js')}}" src="{{ Helpers::assetWithCacheBuster('bower_components/requirejs/require.js')}}"></script>
@else
<script data-main="{{ Helpers::assetWithCacheBuster('js/quiz/bundle.min.js')}}" src="{{ Helpers::assetWithCacheBuster('bower_components/requirejs/require.js')}}"></script>
@endif
