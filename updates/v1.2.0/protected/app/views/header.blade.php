			...
			<ul class="dropdown clearfix boxed boxed-white">
			   <li class="menu-toggle-block clearfix">
				...
				@if(@$config['main']['enableUserLogin'] && $config['main']['enableUserLogin'] != "false")
                    <li id="headerUserMenu" class="menu-level-0 @if(Helpers::isRtl()) pull-left @else pull-right @endif hide">
                ...
                <li class="menu-level-0 @if(Helpers::isRtl()) pull-right @else pull-left @endif search-dropdown hidden-xs">
