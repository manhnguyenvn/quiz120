...
<head>
   ...
   @section('head')
    ...
    <!-- Custom CSS -->
	@if(App::isLocal())
		<link href="{{Helpers::assetWithCacheBuster('/css/main-with-libs.css')}}" rel="stylesheet">
	@else
		<link href="{{Helpers::assetWithCacheBuster('/css/main.min.css')}}" rel="stylesheet">
	@endif

    @if(App::isLocal())
    <link href="{{Helpers::assetWithCacheBuster('/themes/modern/style.css')}}" rel="stylesheet">
    @else
    <link href="{{Helpers::assetWithCacheBuster('/themes/modern/style.min.css')}}" rel="stylesheet">
    @endif
...
<body>
   ...
   <!-- Logging in -->
            ...
            $.get('{{route('getMyPoints')}}').success(function(response) {
                if(response && response.points) {
                    ...
                    if(oldPoints != newPoints) {
                        ...
                        @if(Helpers::isConfigEnabled('leaderboard.showNewPointsAlert'))
    ...
    <script src="{{ Helpers::assetWithCacheBuster('/themes/modern/js/libs/modernizr.min.js') }}"></script>
	<script src="{{ Helpers::assetWithCacheBuster('/themes/modern/js/libs/bootstrap.min.js') }}"></script>
   <script src="{{ Helpers::assetWithCacheBuster('/bower_components/sweetalert/dist/sweetalert.min.js')}}"></script>
