...
@section('foot')
	@parent
	<link rel="stylesheet" href="{{ Helpers::assetWithCacheBuster('/bower_components/jquery-ui/themes/base/sortable.css')}}"/>
	<script src="{{ Helpers::assetWithCacheBuster('/bower_components/jquery-ui/ui/minified/sortable.min.js') }}"></script>
@stop
