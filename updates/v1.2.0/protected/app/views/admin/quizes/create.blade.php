...
@section('foot')
    ...
    <script src="{{Helpers::assetWithCacheBuster('js/admin/admin.js')}}"></script>
    <script src="{{Helpers::assetWithCacheBuster('js/admin/createQuiz.js')}}"></script>

    @if(App::isLocal())
        <script data-main="{{ Helpers::assetWithCacheBuster('js/admin/createQuiz/init.js')}}"
                src="{{ Helpers::assetWithCacheBuster('bower_components/requirejs/require.js')}}"></script>
    @else
        <script data-main="{{ Helpers::assetWithCacheBuster('js/admin/createQuiz/bundle.min.js')}}"
                src="{{ Helpers::assetWithCacheBuster('bower_components/requirejs/require.js')}}"></script>
    @endif
