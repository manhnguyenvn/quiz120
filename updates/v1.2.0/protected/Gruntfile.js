...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: ['<%= yeoman.app %>/css/main.css', '<%= yeoman.app %>/bower_components/sweetalert/dist/sweetalert.css'],
                dest: '<%= yeoman.app %>/css/main-with-libs.css'
            }
        },
        cssmin: {
            dist: {
                files: {
                    '<%= yeoman.app %>/css/main.min.css': [
                        '<%= yeoman.app %>/css/main-with-libs.css'
                    ],
